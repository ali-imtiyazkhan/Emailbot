    ...
    const exchangeCode = async () => {
      try {
        ...
        if (result.success) {
          ...
          setStatus("error");
          setErrorMsg("Failed to connect Gmail account.");
        }
      } catch (err: any) {
        ...
        <AnimatePresence mode="wait">
          {status === "connecting" && (
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.6 }}>
                Exchanging authentication tokens with Google. Please hold on...
              </p>
            </motion.div>
          )}
          ...
          {status === "success" && (
            ...
            >
              ...
              <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: "var(--success)" }}>
