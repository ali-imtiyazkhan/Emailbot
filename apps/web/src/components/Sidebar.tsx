    ...
    <>
      ...
      <aside className="hidden lg:flex w-[260px] h-screen shrink-0 flex-col bg-[#050505] border-r border-[#161616] sticky top-0">
        <div className="flex flex-col h-full px-5 py-7">
          ...
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/[0.03] transition-colors mb-8 no-underline group">
            <LogoMark />
            <div>
            ...
            {navItems.map(({ label, href, icon: Icon }) => {
              ...
              return (
                <Link
                  key={href}
                  href={href}
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl text-[13px] font-medium transition-all no-underline
                    ${active
          ...
          <div>
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/[0.03] transition-colors cursor-pointer">
