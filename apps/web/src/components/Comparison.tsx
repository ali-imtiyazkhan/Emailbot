      ...
      <div className="container">
        <div className="section-head">
          ...
          <p className="section-sub">
            AI-first architecture + WhatsApp integration + open source = inbox management that actually works.
          </p>
        </div>
        ...
        >
          <div className="comparison-header">
            ...
            <div className="comparison-col comparison-col-highlight">
              <span className="col-name">EmailBot</span>
              <span className="col-badge">Open source</span>
            </div>
            <div className="comparison-col">
              <span className="col-name">Zapier</span>
            </div>
            <div className="comparison-col">
              <span className="col-name">Manual Filters</span>
            </div>
          </div>
