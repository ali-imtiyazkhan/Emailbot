  ...
  return (
    <footer>
      <div className="footer-left">
        <div className="footer-logo"><LogoIcon />EmailBot</div>
        <div className="footer-built">Built for the modern inbox.</div>
      </div>
      <ul className="footer-links">
        <li><a href="/dashboard">Dashboard</a></li>
        <li><a href="#how">How it works</a></li>
        <li><a href="mailto:support@emailbot.com">Contact</a></li>
      </ul>
      <span className="footer-copy">© {new Date().getFullYear()} EmailBot</span>
    </footer>
  );
}
